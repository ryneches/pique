...
Usage : ./er_recalculate.py IP.bam BG.bam, map.gff, input.bookmark, project_name
"""

D  = pique.data.PiqueData( sys.argv[1], sys.argv[2], sys.argv[3] )
...
print '>name: Pique bookmarks for ' + sys.argv[5]
